...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            chips = underground_runner(chips, active_slot, stats, profile)
        elif choice == 'B':
...
def show_stats(chips, stats, profile):
    ...
    bank_box = box([
        ...
        f"利息:      {colored('$' + str(stats.get('bank_interest_earned', 0)), C.GREEN)} / {colored('$' + str(stats.get('loan_interest_paid', 0)), C.RED)}",
